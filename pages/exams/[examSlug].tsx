...
export default function Exam({ exam }) {
    ...
    <form onSubmit={handleNewQuestionSubmit}>
        ...
        <label>
            Title:
            <input type="text" value={newQuestionTitle} onChange={(e) => setNewQuestionTitle(e.target.value)} />
        </label>
        <label>
            Description:
            <textarea value={newQuestionDescription} onChange={(e) => setNewQuestionDescription(e.target.value)} />
        </label>
        <label>
            Image:
